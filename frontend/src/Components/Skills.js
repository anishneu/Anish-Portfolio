...
const skillCategories = [
  {
    ...
    skills: [
      ...
      { name: 'Shell', icon: `${CDN}/bash/bash-original.svg` },
    ],
  },
  {
    title: 'Frontend & UI',
    skills: [
      ...
      { name: 'Kendo UI', icon: `${CDN}/typescript/typescript-original.svg` },
      { name: 'AG Grid', icon: `${CDN}/javascript/javascript-original.svg` },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'OpenCV', icon: `${CDN}/opencv/opencv-original.svg` },
      { name: 'pandas', icon: `${CDN}/pandas/pandas-original.svg` },
      { name: 'NumPy', icon: `${CDN}/numpy/numpy-original.svg` },
      { name: 'CNN', icon: `${CDN}/tensorflow/tensorflow-original.svg` },
      { name: 'Hugging Face', icon: `${CDN}/python/python-original.svg` },
      { name: 'Ollama', icon: `${CDN}/linux/linux-original.svg` },
      { name: 'RAG', icon: `${CDN}/databricks/databricks-original.svg` },
      { name: 'Agentic AI', icon: `${CDN}/tensorflow/tensorflow-original.svg` },
    ],
  },
  {
    ...
    skills: [
      ...
      { name: 'Render', icon: `${CDN}/docker/docker-original.svg` },
    ],
  },
  {
