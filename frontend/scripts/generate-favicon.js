 ...
 * — removes light background, recolors logo to brand primary (#c9a85a)
 */
const fs = require('fs');
...
/** Light-mode primary (light gold) — beige / gold / sand clay / soft peach */
const PRIMARY = { r: 201, g: 168, b: 90 };
